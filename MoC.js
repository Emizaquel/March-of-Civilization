...
function add_perks(){
    ...
    new perk("Planar Ship", "You understand the mechanisms of the boundaries between realms and how to manipulate them in such a way that you can create a self-sustaining pocket of existence to pass through them, which could be used in a vessel of sorts that can travel between realms.", 350n, 1n, [], 9)
    ...
    new perk("Trans-Realm Interstellar Porter", "You know how to create a series of device capable of transporting objects across planar boundaries. From portable gadgets designed to move a single person to large systems capable of moving entire colony ships. This provides a near instant transition between realms and can even perform some limited spatial correction, allowing you to arrive safely on the other side.", 250n, 1n, [], 2)
    ...
    new perk("Pure Industry", "You know how to overcome the logistical challenges that would prevent you from operating at a grand scale. You know how to source the required components, materials and reagents for any technology you know how to produce and how to scale that production to meet any level of demand. Granted, those requirements might be beyond you.", 0n, 1n, [], 0)
    ...
    new perk("Song of the Ages", "You can sing! In fact you can sing amazingly well. Your voice and skill are such that this alone would make your performances almost hypnotic, inspiring emotions and inciting desire. Your skills do not, however, end at performance, your new understanding of rhythm, melody, tone and symbolism means that you are able to produce works that will stand the test of time.", 200n, 1n, [], 0)
    ...
    new perk("Physical Chemistry", "You know how take into account both physical and chemical properties in order to tailor your reaction procedures in order to ensure that you create the specific structures you desire.", 100n, 1n, [], 0)
    new perk("Red-line", "You can use every sense at your disposal to understand the state of any device you are operate it and push it to the utmost of it's capabilities and perhaps even beyond if you are willing to make some repairs later. Or if there might not be a later.", 200n, 1n, [], 0)
    new perk("False Vacuum Specialist", "You understand the nature of false vacuum states, and are able to understand the interactions between the various quantum fields that make up the universe and how to settle them into local minima with interesting laws of physics.", 400n, 1n, [], 1)
    new perk("Second Order", "You know how to create things that create things, looking not at what you have in your hands, but what will come of what you have made.", 50n, 0n, [], 0)
    new perk("Abyssal Architecture", "The crushing weight of the ocean spawns no dread from you, nor do you fear what lies within the dark depths. For you know how to carve a paradise even from this seemingly inhospitable space. From domestic domes to intricate submerged stations you can create habitable spaces under water with ease.", 100n, 1n, [], 0)
    new perk("Cavernous Construction", "Do you live under a rock? Oh, wait? You do? Indeed, you know how to carve out living spaces deep into the dirt so comfortable that even divorced from daylight one can find the scene downright domestic. From colossal cavern cities to maze-like mine-shaft municipalities you know how to create  a home deep underground.", 100n, 1n, [], 0)
    new perk("Trans-planar Tap", "You understand certain aspects of planar boundaries that allow you to make them permeable to energy, taking advantage of the natural energy gradients between different planes. You might draw power from planes with a naturally higher energy state creating an effectively endless supply of energy, or dump waste energy into a plane that is naturally less energetic than your own.", 250n, 1n, [], 9)
    new perk("Black Horizon Plant", "You have tamed the beast that lies at the bottom of infinity. You have designs for power plants that use the event horizons of black holes to convert arbitrary mass directly into energy. The throughput and efficiency scales with the size of the generator but you have designs for man-portable units can recover upwards of 90% of the mass energy as something useful and planetary power stations that creep into the range of nine nines.", 250n, 1n, [], 2)
    new perk("Gravity Shields", "Shields are something of a misnomer here. These effectors oppose the gradient of gravity wells, within their operational bubble to create a zone where harsh gravitational effects are abated. While the personal scale devices top out at a hundred or so meters per second squared, capital ship scale systems can even handle the sheer walls of a black hole's gravity well, as long as you don't get too close to the event horizon.", 200n, 1n, [], 2)
    new perk("High Impulse Thrusters", "These engines are quite the HIT with speed demons! At full burn they are capable of outputting enough thrust to accelerate their rated mass at up to half a percent of c per second. You know how to make models as small as a pen that are rated up to two hundred kilograms to those dozens of meters across capable of moving a hundred million. You even know how to make the fuel, an extremely energy dense exotic matter that means your fuel tanks are reasonably sized.", 150n, 1n, [], 2)
    new perk("Stellar Extraction and Transmutation Station", "These space stations are designed to orbit stars in close proximity, allowing them to make use of powerful magnetic lifting systems to extract vast amounts of matter. Within it lies an immensely powerful fusor, capable of repeatedly combining atoms even beyond the point that it takes more energy than it returns enabling it to produce any element in industrial amounts from nothing but the star and the energy it produces.", 350n, 1n, [], 2)
    new perk("Particle beam Weapon", "A barrage on all fronts, you know how to create a range of weapons that deal sustained kinetic, thermal and radiological damage at the same time using a beam of highly energised particles. From palm-sized holdouts to capital weapons you have a full catalogue of designs.", 150n, 1n, [], 2)
    new perk("Guns, guns, guns", "A rather uncivilised weapon, but war is not particularly civilised. And there's something to be said about the simple honest simplicity that a gun represents. You know how to create projectile weapons that make use of stored chemical and electrical energy from handheld solutions to static emplacements.", 50n, 1n, [], 2)
    new perk("Survival Kit", "There's something to be said for starting from scratch you know how to create tools and weapons from just the stuff you can find lying around. You understand how to best make use of the readily available resources with only a minimum of processing.", 50n, 1n, [], 2)
    new perk("Castle Forged", "Ah, a medieval arsenal, every warriors romance. There is just something about doing the basics well. You know how to create all sorts of simple weapons from metal and can even scale things up to the wondrous Trebuchet. For when you don’t very much like that fellow all the way over there.", 50n, 1n, [], 2)
    new perk("Ki Healing", "You know how to use Ki to stimulate and optimise natural healing, accelerating recovery from the scale of days to minutes (assuming you have the reserves to do so). This method has the benefit of retaining any benefits that would have resulted from taking the time to heal normally.", 100n, 1n, [42], 5)
    new perk("Healing Magic", "You know about how magic interacts with damage, or rather changes made to the natural state of an individual. You can craft spells that will undo injuries and remove damage such that it is as though the person or item never experienced the hardship in question.", 100n, 1n, [83], 7)
    new perk("Psychic Surgery", "You understand the nature of the natural destructive loops that minds can enter, harmful mental structures that appear in response to stress of biological stimulus. You know how to safely manage these, transitioning them towards more controllable and comfortable states through the use of psionic treatment.", 100n, 1n, [22], 4)
    new perk("Spiritual Healing", "You know how to effect the soul in such a way that clears damage and promotes healing, allowing for people to grow on a fundamental level allowing them to reach heights that may have once been denied to them.", 100n, 1n, [0], 3)
    new perk("Causal Pruning", "You know how to cut away at the causality that makes up an individual, permanently returning them to a previous state. You do need to be careful of your trimmings however, such detritus has interesting properties some of which may even prove interesting to forces that might chance a glance at the realms below.", 100n, 1n, [104], 8)
    new perk("Ground Penetrating Scanners", "You know how to create a series of scanners that can detect the structure of solid objects. From handheld units that can peer a few meters past the surface to space-based scanners dozens of kilometres across that can analyse the composition of entire planets at once.", 150n, 1n, [], 2)
    new perk("Quantum Computing", "You know how to use quantum effects to perform logical transformations over representations of continuous datasets, allowing you to explore every path within a set range at once.", 150n, 1n, [], 1)
    new perk("Automatic Alchemy Arrays", "you know how to create devices that perform alchemical transmutations automatically. you can create arrays that can reshape matter with ease and replicate any other alchemical operation you know of.", 200n, 1n, [], 6)
    new perk("Landing is for Peasants", "You know how to make a 'short' (in interstellar terms) range point-to-anywhere and anywhere-to-point teleporter capable of transporting a landing party and their baggage to and from a spaceship in orbit over the planet.", 50n, 1n, [], 2)
    new perk("Policy", "You know how to create laws and regulations that effectively enforce a certain opinion, with the appropriate checks and balances that would allow you to ensure that the enforcement of these policies remain in line with your vision.", 100n, 1n, [], 0)
    new perk("Legislation", "You know how to word arguments and introduce ideas in a way that makes them more acceptable to the people in power, and when that fails, you know how to analyse the foundations of their power and are able to find what levers exist to bring them to your side via alternate avenues.", 100n, 1n, [], 0)
    new perk("Grand Strategy", "ou understand what it takes to play numerous self-interested players against each other. From managing tensions to brokering peace... or perhaps inciting incidents, you understand the delicate interplay between different nations and how to navigate or even steer it.", 100n, 1n, [], 0)
    new perk("Backup Body", "You can form a connection between your essence and a compatible vessel. Should you ever suffer enough damage to destroy your original body or break the link it has to your soul, you will immediately transfer into the other vessel.", 50n, 1n, [], 10)
    new perk("Arcane Intelligence", "You know how to encode complex decision trees and sensory capabilities into magical constructs, allowing the near perfect replication of a desired set of behaviours. Without a soul, these intelligences do not change but can perfectly replicate even the mental construct you program into them.", 200n, 1n, [], 7)
    new perk("Liminal Space", "You understand the boundaries between realms and how to blur them, creating a passageway that naturally transitions from one space to the other in a way that tends to be particularly easy on what is being transported", 100n, 1n, [], 9)
    new perk("Blink", "Planes are not so distant from the right perspective, indeed, they can be said to overlap. You understand this superstructure and the events that can swap the contents of a volume between different planes.", 100n, 1n, [], 9)
