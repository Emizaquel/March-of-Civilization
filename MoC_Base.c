...
static const uint16_t core_prizes = 453;
...
int main(int argc, char const *argv[])
{
    ...
    Add_Prize(0, "Ghost Traps", "You can create devices that can contain spiritual presences. These traps activate under specific conditions and drag any spiritual presences not bound within a physical anchor into a holding chamber from which they can later be released", 1, Table_Resolver(0));
    ...
    Add_Prize(500, "Final Breath", "In one final gasp, in an exertion where you have nothing to lose, you can draw upon the last dregs of your strength with utter abandon, increasing your capabilities by orders of magnitude for a short period, though this does significantly damage your mortal form. It will take quite some time for you to recover, and even the most powerful restoratives and non-transformative procedures applied will not significantly improve your recovery.", 1, Table_Resolver(42));
    ...
    Add_Prize(200, "Piercing Eye", "The limitations of the physical form cannot be overcome through skill alone, and there are always compromises to be made. Compromises that you can easily identify. From even a single example, you know what you need to do in order to counter any specific move of means of attack, though leveraging that information is a matter of your own skills.", 1, NULL);
    ...
    Add_Prize(0, "Elemental Enchantment", "You are able to imbue items with elemental powers, granting them permanent extensions of their capabilities through their new elemental enhancements, such as blades that burn and hammers that send out bludgeoning shockwaves of wind", 1, Table_Resolver(85));
    ...
    Add_Prize(1200, "Geas", "You can create an agreement between two or more people that they are forced to uphold. Barring escape clauses written into the agreement at the time of creation, there is no way to break these bonds.", 1, Table_Resolver(88));
    ...
    Add_Prize(200, "Resins", "You have a deep understanding and intuition surrounding the interactions of different polymers and other large molecules, allowing you to design and deploy chemicals that will take on the properties you need once cured", 1, NULL);
    ...
    Add_Prize(0, "Signature Style", "You have a signature style, one that is utterly impossible not to recognize as yours and yet impossible to for someone else to replicate", 1, NULL);
    ...
    Add_Prize(0, "Master's Qualification", "You have gained a level of education in a certain subject that would make you a master in that field. You even have the paper to prove it. You have a certificate that will be accepted by any relevant power that you have the relevant qualifications and it will pass any forms of validation check.", 255, NULL);
    ...
    Add_Prize(200, "Liquid Light", "You can precipitate photons into a concentrated fluid-like substance. Though this has many uses, the simplest is to let it evaporate into light, which it does relative to its surface area. You also gain the knowledge needed to properly store and preserve this substance to prevent unwanted degredation, as well as how to reverse this process.", 1, NULL);
    ...
    Add_Prize(500, "Inner World", "You have the designs for an artificial demiplane, a limited volume of space that acts as though it was it's own universe. The exact design is somewhat random, but each time you gain this prize you gain the designs for a new one themed to match a different workspace or environment that you would find interesting in the moment.", 255, NULL);
    Add_Prize(200, "Subtle Instruments", "There is a time for grandstanding, and there is a time for subtlety. From multi-stage poisons to subtle suveilance devices and even devious traps, you know how to create tools that enables covert action of all kinds", 1, Table_Resolver(181));
    ...
    Add_Prize(0, "Like a Steel Trap", "You have a mind well suited to alchemy. Not only can you hold incredibly complex alchemical processes in your mind with ease, you can also perfectly memorise and visualise complex structures perfectly with but a single glance", 1, NULL);
    ...
    Add_Prize(150, "Fission Works", "You have the designs, knowledge and training to make all of Fission Work's wide gamut of fission-based nuclear reactors and radioisotope thermoelectric generators: ranging from muncipal solid-core designs to gas-core fission and ultra-light manportable nuclear power units.", 1, NULL);
    Add_Prize(200, "Mechatronics In Motion", "You are inflicted with a dream, a dream of a love-letter to the Human form, arms and legs made mobile through designed artifice, then cladded in armor, and moved by mechanisms fueled by engineered power sources. Designs of leg, and arm drive trains come to you, as is the dizzingly complex systems or software required to let it keep it's balance, and most importantly: to move. This is the skill to make arms and legs that work like a human reflected into your chosen mechanical art, but other 'exotic' forms are not too hard to puzzle out, so long as they got something like legs and arms.", 1, NULL);
    Add_Prize(200, "Soul of the Engine", "You know how to design and make the gamut of techniques of garnering energy from combustion: engines, fuel cells, turbines and all. If it burns, you can think of a few ways to make it into motion.", 1, NULL);
    Add_Prize(200, "Power To The People", "There are a great many ways to provide municipal power to a town, a city, a country, or even a world. The Civil Engineering required to tap into Geothermal springs, or truckloads of coal, or a fusion reactor or any large-scale municipal power system into the electricity fed to the needs of the people come to you easily.", 1, NULL);
    Add_Prize(100, "Accelerate the Projectile", "Bolts, Arrows, Bullets, Flechettes and more are all under your perview. You have a grasp on engineering everything required to make a device capable of launching a projectile using explosive-combustion or muscle-power in its many forms. Using more exotic acceleration methods come to you more easily, as well.", 1, NULL);
    Add_Prize(200, "Talk and See with Radios and Lasers", "You have the knowledge of using Electromagnetic frequencies, most often Radio and Light waves, to communicate, and sense. This most often manifests in radio wave and laser communication, and RADAR/LADAR systems. Necessarily, this comes with the knowledge to protect and counter against such equipment, like using Electromagnetic Countermeasures or Electromagnetic Pulse Generating weapons.", 1, NULL);
    Add_Prize(175, "Make Your Artifical Gravity", "The applied engineering of scientific study of Gravitics made manifest: A series of designs towards supplying artifical gravity deck-plates, mass-tractor beams, kilometers wide inertial syncronization fields, and crude examples of gravitic weapons that show effective performance comparable to magnetic railgun weapons due to their imprecise manipulation of the gravitational fields that would otherwise be implemented into pinnacle weapons. You can make a devestating maul with this.", 1, NULL);
    Add_Prize(150, "Song Series Weaponized Accoustics", "The sonic weapons of a enlightened era, including examples of precise narrow-beam sonic pulse weapons capable of nonlethally disabling a targeted individual through lighter armor by temporarily shutting down their nervous system. Comes in a wide variety of packages most of them man portable, as well as more primitive examples that are only effective against targets that can hear with more traditional effects-- afflicting nausea and hearing loss.", 1, NULL);
    Add_Prize(100, "Ink to Paper", "The gamut of designs to put printed materials into the hands of the people are available to you, running from primitive printing presses on parchment to typewriters and ball-point pens to cutting edge paper-preparing chemical processes, and full color gloss printers. the many, varied steps of turning raw materials into the written word (or picture) are available to you.", 1, NULL);
    Add_Prize(100, "The Coastguard Supply", "A coastguard requires a great many vehicles, equipment and systems to run, ones that you do not have to make designs for now. You have been given all the tested and used designs on functional ships, boats, buildings, helicopters and the varied equipment that would enable the day to day operations of a coastguard or similar nautical rescue service.", 1, NULL);
    Add_Prize(200, "Antimatter", "Antimatter is volatile, and the ultimate storage mechanism for harnessable energy in hard-science environments. You know the science behind how to produce, store, and harness antimatter in all its various quantities. the smallest amounts are most economically usable for radiation medicine, but higher orders of magnetitude have obvious manufacturing, scientific, and miltiary applications.", 1, NULL);
    Add_Prize(150, "Subtle signals", "You can pick up what is being put down - to an extent beyond what is merely physically possible. This not only allows you to understand the subtle nuances of communication, but also absorb and assimilate the psionic component making you a better student.", 1, Table_Resolver(22));
    Add_Prize(750, "Universal Simulation Module", "You know how to create a extremely computationally intensive software package that can simulate the local universe with respect to the actions of the people inserted into it. Your understanding of this system allows you to identify various components, allowing you to extract internal functionality for any other purpose.", 1, NULL);
    Add_Prize(200, "Precision Body Control", "You are able to control your body incredibly preciesly first on the level of individual voluntary muscle groups, then to the level of nomally subconcious aspects such as metabolism, then to normally involuntary processes such as your heartbeat and hormones and finally on a cellular level.", 4, NULL);
    Add_Prize(200, "Logic", "You know how to describe problems in a rigorous manner. Though this may seem a simple thing, this allows you to break down complex procedures as a simple set of logical processes which are easily achieved through computation of all kinds.", 1, NULL);
    Add_Prize(250, "Shapeshifting", "You know how to create spells and enchantments that allow the target to take on another form, first simply others of their own kin, then any others of their own kind (animate remains animate and inanimate remains inanimate), then finally anything at all", 3, Table_Resolver(84));
    Add_Prize(300, "Mystic Alchemy", "You know how to take your akills into a realm that is often beyond the reach of most alchemists. To effect the world beyond the physical and reach for what lies beyond the material world. This allows you to apply alchemical principles to various supernatural forces, starting with Ki, then magic, then spiritual energy and finally the conceptual underpinnings of reality itself.", 4, NULL);
    Add_Prize(350, "Spiritual Entities", "You know how to create independent spiritual entities, self contained souls with enough power to act upon the physical world. These are fully independent entities with agency and the ability to act on your behalf or those who you assign them to, while still remaining undetectable to anyone without spiritual senses.", 1, Table_Resolver(5));
    Add_Prize(350, "Spiritual Guardians", "You know how to create autonomous subsections of a soul, granting it a protector and guardian that works constantly and independently of the soul itself. These guardians are not actually seperate from the soul and can grow alongside it.", 1, Table_Resolver(5));
    Add_Prize(200, "Splicing", "You have a deep understanding of how genetics translate into phenotypic expression. It takes you only a little experimentation to isolate what specific gentics are resposible for various biological structures and you have a knack for integrating those same structures into others - even into mature specimen.", 1, NULL);
    Add_Prize(350, "Kaiju", "There are creatures, monstrous creatures that defy any extant concept of biological limitation. You understand these creations, allowing you to creatures of immense size and strength.", 1, Table_Resolver(104));
    Add_Prize(200, "Unending Endurance", "Regardless of how long you have been working, and how much you have been exerting yourself, so long as you are in good health you can continue to work. This removes your need for food and sleep.", 1, NULL);
    Add_Prize(300, "Hammerspace", "You know how to creates pocket realms that are integrated into the natural functions of living beings, allowing them to store items in a convenient and weightless manner.", 1, NULL);
    Add_Prize(250, "Impossible Proportions", "You know how to alter the internal geometry of beings and objects in such a way that allows them to take on forms far larger than they seem to be able to at first.", 1, NULL);
    Add_Prize(150, "Spooky Action", "You have a good sense of how to generate forces at a distance, from telekineisis to dealing damage directly, you can easily design spells and artefacts to achieve these feats.", 1, Table_Resolver(84));
    Add_Prize(300, "Mystic Places", "Anchoring magical effects to places is no mean feat - indeed most such places are born of immense magical exposure over a great deal of time. Still, you know how to tie your workings into the ambient supplies of magic making them self-sustaining", 1, Table_Resolver(84));
    Add_Prize(150, "Pulsar Series Laser Weapons", "From side-arms and concealable hold-outs to static emplacement and void-navy class weaponry, this series of laser weapons are decent examples of all scales of weaponry.", 1, NULL);
    Add_Prize(150, "Accrection Series Plasma Weapons", "This collection of plasma weapons contain everythign from melee hold outs to orbital defence weapons. Though not the apex of this class of weapon, they do represent a collection of decent designs that could fill practically every need for an interstellar war-effort", 1, NULL);
    Add_Prize(150, "Sol-Series Fusion Plants", "These collection of General Hydrogen Fusion Plants provide plenty of options from personal portable units to plants that can power colony craft and can produce a respectable amount of power from any form of hydrogen. Indeed, you also have a number of options for open-chamber designs that can double as thrusters.", 1, NULL);
    Add_Prize(150, "Sunshine in a Can", "You know how to create a large variety of fusion explosives for uses that range from civilian to strategic. These can scale from man-portable anti-materiel grenades to black-navy straegic weapons capable of destroying orbital installations. In addition to the plans, you also have the knowledge neccessary to put them into practice.", 1, NULL);
    Add_Prize(150, "Big Red Button", "You have access to the plans and understanding necessary to make a wide variety of fission-based weaponry, capable of acting as tactical munitions to strategic options - on a planet and even beyond it. Indeed, this collection even includes systems that could be used for civilian purposes, though only if the timeline accounts for the fallout.", 1, NULL);
    Add_Prize(25, "Splitting", "You know how to work your way into weaknesses, applying devasting force from within. You can create all sorts of tools to take advantage of this effect.", 1, NULL);
    Add_Prize(25, "Slicing", "You know how to take advantage of the force you can produce over time concentrating and building up damage until you overcome your opponents defences. you know how to create all sorts of tools that take advantage of this effect.", 1, NULL);
    Add_Prize(25, "Piercing", "You know how to concetrate force, and even the strongest armour can only do so much if there is so little of it. You know how to take advantage of this effect to produce all sorts of tools.", 1, NULL);
    Add_Prize(25, "Crushing", "You know how to build on overwhelming force, to destroy your foes though simply dealing more damage than they can handle. You know how to make tools of all sorts that enable you to vastly augment the forces you can bring to bear.", 1, NULL);
    Add_Prize(100, "Strike True", "You know how to create weapons intended for close-quarters combat. From daggers to spears, all forms of melee weaponry come easy to you and you can even design tools to best suit any user you care to name.", 1, NULL);
    Add_Prize(200, "Climatology", "You have a deep understanding of the interactions between immense volumes of matter and energy, allowing you to predict the evolution of complex systems on the scale of planets. This is primarily geared towards the prediction and manipulation of weather systems, but can take into account the effects of anything of a scale that wouldn't simply be drowned out.", 1, NULL);
    Add_Prize(200, "Anatomy", "You have a deep understanding of the mechanics of biological bodies, granting you a sense of how all the parts of the body function and interact. You fully understand your own body and can easily extend that to any other similar life-form but it only takes a little research for your to expand that to other bodies.", 1, NULL);
    Add_Prize(150, "Antipathogen", "A collection of drugs that act as broad-spectrum anti-biotic and anti-viral treatments. Perfect for use against all but the strongest drug-resistant strains.", 1, NULL);
    Add_Prize(150, "Battle Glue", "A easy to apply topical disinfectant and pathogen barrier that can seal up any injury preventing infection and accelerating the healing of non-gaping wounds.", 1, NULL);
    Add_Prize(500, "Ideal State Enforcement", "Your soul remembers your ideal form the perfect you. And there are ways to project that image back onto reality. Through your arts you know how to reconstruct parts of the body lost to the physical universe.", 1, Table_Resolver(1));
    Add_Prize(0, "Enduring", "You know how to design and modify systems in such a way as to protect them from the ravages of time - allowing them to operate as they should for tens of times longer than they otherwise would be capable of.", 1, NULL);
    Add_Prize(150, "Fighting Fit", "While Ki already slows aging and fights back against the injuries time inflicts, there are ways to improve this effect, allowing you to effectively turn back the clock by a little bit.", 1, Table_Resolver(43));
    Add_Prize(200, "MEMS", "Sometimes it is simpler to take advantage of physical interactions, even with highly advanced computation permitting you various ways of sensing the world. You know how to scale down various devices and integrate them into computational systems.", 1, NULL);
    Add_Prize(150, "Hot", "You know how to transmit the property of alchemical heat to any substance, empowering active alchemical properties such as causticity, heat generation, and its ability to break apart and purify", 1, Table_Resolver(64));
    Add_Prize(150, "Cold", "You know how to transmit the property of alchemical frigidity to any substance, allowing it to resist and passivate alchemical properties and to bind other distinct substances together", 1, Table_Resolver(64));
    Add_Prize(150, "Wet", "You know how to transmit the property of alchemical humidity to any substance allowing it to be more indistinct, fluidic, flexible and malleable as well as", 1, Table_Resolver(64));
    Add_Prize(150, "Dry", "You know how to transmit the property of alchemical aridity to any substance, allowing it to be more discrete (in the physical sense), solid, rigid and stiff", 1, Table_Resolver(64));
    Add_Prize(250, "Earth", "You have grokked the element of Earth, one of the fundamental aspects of the universe. The element of Earth is not the simple dirt around you, but rather the qualities that are more easily seen in it. The stability, weight and impermeability that it displays so well.", 1, Table_Resolver(64));
    Add_Prize(250, "Air", "You have grokked the element of Air, one of the fundamental aspects of the universe. The element of Air is not the simple atmosphere, but what differentiates it from what is clearly other. The ability to become a formless ephemeral substance that escaped understanding for so long.", 1, Table_Resolver(64));
    Add_Prize(250, "Water", "The element of water is not merely the substance that fills the oceans, it is that which takes in all things and is free of such base considerations as simple shape and structure for it is fluid in a way that nothing else is.", 1, Table_Resolver(64));
    Add_Prize(250, "Fire", "Fire is a strange element but you know it nonetheless. It is the element of effect and change, that ability to alter others, to cause heat and to remove weight from that which it alters.", 1, Table_Resolver(64));
    Add_Prize(500, "Curses", "The ability to create spells that resist removal, usually by engineering a deliberate weakness that empowers the general strength", 1, Table_Resolver(84));
    Add_Prize(200, "Visualization", "To believe in something, you do not merely need to be able to want it, but to see it as a truth of the world. That faith and understanding that allows the immaterial to be as real to you as the ground you walk on. Not only does this improve your ability to cast magic, it also improves your general capability to conceptualize phenomena of all kinds.", 1, NULL);
    Add_Prize(500, "Alternate Forms", "A sort of limited shapeshifting, gain the ability to take on an alternate form capable of supporting your soul and consciousness, a robot, animal or even an entirely separate species.", 255, NULL);
    Add_Prize(300, "True Worth", "Sometimes progress isn't about creating something new, but instead about using what you have more effectively. You see further than the surface and are able to see exactly what you can use something for.", 1, NULL);
    Add_Prize(250, "Beyond Speech", "You can pick up on the subtle psionic traces that cling to speech, sign language or other active forms of transmitted communication - as well as amplify your own. This allows you to speak with and be understood by any sapient being.", 1, Table_Resolver(22));
    Add_Prize(250, "Beyond Script", "You can detect the psionic residue that even seemingly blank people leave as they record information, allowing you to understand the meaning of any information stored in a permanent or semi-permanent form.", 1, Table_Resolver(22));
    Add_Prize(200, "Hard Robotics", "Ah, that dance of the physical and digital. You have an understanding of the mechanics and logic surrounding servos, pulleys, levers and other devices that allow for the movement of various rigid armatures.", 1, NULL);
    Add_Prize(200, "Soft Robotics", "Ah, that dance of the physical and digital. You have an understanding of the mechanics and logic surrounding bladders, hooks, belts and other devices that allows for the controlled deformation of flexible armatures.", 1, NULL);
    Add_Prize(200, "Bioengineering", "You understand how to translate the intricate dance of genetics into complex biological structures, creating novel tissues, organs and even entirely new creatures. You not only understand how to design such things, but also the conditions and processes that would have to take place in order to bring them into reality.", 1, NULL);
    Add_Prize(150, "Sacrifice", "To open one's mind, one must eschew prior preconceptions. One of the best ways to do so is to overcome the taboos that have ruled your life thus far. By breaking various taboos in a ritualistic manner, you can more effectively make use of knowledge beyond the norm", 1, NULL);
    Add_Prize(25, "Branch Prediction", "You understand the delicate nature of temporal branching, and how timelines shift and split. Thus, should you end up in the past, you know how to travel along the timelines you are interested in to get back to the correct one, and how to safely make limited changes.", 1, NULL);
    Add_Prize(25, "Inverse Kzinti Lesson", "Conservation of Momentum, it's the very fundamentals of physics, perhaps one of the first lessons anyone learns. You have a powerful sense of reaction forces and the ability to turn any mass launcher into an effective thruster.", 1, NULL);
    Add_Prize(1000, "Eldritch Aspect", "Your soul resonates with some aspect of the universe, something utterly fundamental to the way that the universe works. No trite element or other descriptive aspect, but those things that cannot be extracted or contained.", 1, Table_Resolver(104));
    Add_Prize(350, "Portal Barrier", "If you don't want to get hit by something, why get hit at all. Through careful manipulation of the fabric of space-time you can create barriers that will redirect even energy weapons in whatever direction you choose - perhaps back in the direction they came from.", 1, NULL);
        Add_Prize(250, "Wisdom of the Ages", "With a name and enough identifying information to uniquely describe them, you can use the atemporal nature of the soul to call upon the shade of anyone who has died. This state does not harm them nor is it inherently uncomfortable, and indeed, the two of you cannot interact in any way bar harmless communication. Convincing them to part with their secrets is up to you to do", 0, NULL);
    Add_Prize(500, "Guy In The Chair", "You don't need to be on the scene to help. So long as you have a real-time ability to influence the situation, you can bring your full might towards helping out", 0, NULL);
    Add_Prize(0, "Neat Trick", "You can add aesthetic and otherwise non-functional flourishes to your work without needing to spend any more time than if you focused your efforts on a purely functional barebones piece", 0, NULL);
    Add_Prize(300, "Shapeshifting", "You now have a supernatural ability to manipulate your body, which grows stronger each time you roll this perk. At first you might only manipulate your tissues, reshaping them into altered forms. Then you power extends to genetic expression allowing you to change what properties your tissues express. Your penultimate upgrade is your ability to manipulate your very DNA, altering the foundations of your physical form.Finally, your power extends even to the materials around you, enabling you to integrate even inorganic materials into your body, reshaping them as you see fit", 4, NULL);
    Add_Prize(0, "Infomorph", "Your mind and soul now have a stronger connection. This ensures that any upload of your mind is indeed you for all intents and purposes - magical or otherwise. Your mind can also heal from imperfect transfers given time, drawing upon the information stored in your soul", 0, NULL);
    Add_Prize(450, "There's something there", "You have a sense for the unlikely, the potential timelines where the uncommon occur. You are able to influence your vicinity such that uncommon outcomes are more likley to happen to you", 0, NULL);
    Add_Prize(200, "True Genius", "You have a natural aptitude for seeing connections and patterns, beyond the norms of your kind. What's more, your observations tend to be accurate more often than not - allowing you to come to conclusions others might miss", 0, NULL);
    Add_Prize(75, "Calcination", "You understand how to alchemically seperate solids into their component calxes, displaying unique qualities of the source materials. Each material can be split into dry True Calxes and wet Salts", 0, NULL);
    Add_Prize(75, "Distillation", "You know how to alchemically distill liquids seperating them into purer forms with Hot and Cold propeties", 0, NULL);
    Add_Prize(75, "Sublimation", "You know how to extract the airy spirits from solids through the alchemical process of Sublimation, capturing materials that are paradoxically hot and dry without manifesting the properties of flame", 0, NULL);
    Add_Prize(75, "Descension", "You know how to extract the earthly elements from liquid reagents, precipitating the dry and cold properties of a fluid into a pure state", 0, NULL);
    Add_Prize(75, "Solution", "You have learned to imbue the properties of non-fluid materials into fluids, allowing you to create liquids with the properties of a variety of different substances", 0, NULL);
    Add_Prize(75, "Coagulation", "You know how to combine the earthly properties of different liquids to extract a solid substance, seperating them into component parts", 0, NULL);
    Add_Prize(75, "Fixation", "You know how to force solids to take on the properties of liquids and gasses, imbuing them with additional useful traits", 0, NULL);
    Add_Prize(75, "Ceration", "You know how to soften materials through various alchemical processes, granting them properties not unlike metal or wax, introducing Wet properties unto the substance", 0, NULL);
    Add_Prize(150, "Blood Pills", "You know how to create pills from your own blood and Ki that can store vast amounts of your vital energy. Each pill contains close to a 120% of your Ki reserves at the time of creating the pill and combined with the medicinal components of the pills, they can even provide a mild regenerative effect allowing you go from exhausted to fighting fit in moments, as though you had a good meal and a full night's rest", 0, Table_Resolver(42));
    Add_Prize(150, "Pressure Points", "You gain the ability to identify precise locations on the body of your own species as well as any body that you have had the opportunity to carefully examine, growing stronger with each time you toll this perk. First you learn how to manipulate muscles, forcing them to activate, relax or even enter a chaotic series of spasms. Next you learn how to manipulate the senses, dulling or even amplifying them temporarily. Finally, you learn how to manipulate even involuntary processes. This can be used medicinally or simply to strike someone down with a precise poke", 0, NULL);
    Add_Prize(0, "C-C-C-Counter!", "Your reflexes are honed well enough that you can instinctively react to suprise attacks and other attempts to catch you off your guard, allowing you to attempt to defend yourself", 0, NULL);
    Add_Prize(300, "Uncertainty", "There is an underlying structure to the seeming chaos at the bottom of reality, and with the right knowledge it becomes possible to manipulate such a thing. You now understand the nature of uncertainty that dwells in the smallest corners of physics allowing you such feats as teleportation and pair production", 0, NULL);
    Add_Prize(200, "Heat", "What by many is thought to be a wild and chaotic result of entropy has rules of its own. And while they may be complex, they can be manipulated. You now have deep and detailled understanding of how heat propogates and is effects substances", 0, NULL);
    Add_Prize(250, "Evolution", "You understand how all sorts of systems respond to stimuli, especially those systems that can adapt. This goes beyond mere biological evolution, you are able to work out how any sufficiently complex conglmeration will change over time", 0, NULL);
    Add_Prize(200, "Structural Psychology", "You have a deep understanding of how physical structures translate to operational function, something that applies especially well to logical systems. Though it might take you some time and experiments, you can even extrapolate the generalities of the thought processes and instincts of a lifeform with enough information about their nervous system or whatever analogue they may have, as well as the effect that stimulus and even alteration to those cognitive structures would have", 0, NULL);
    Add_Prize(200, "Experimental Psychology", "You have a good sense on the externalised aspects of the mind, and with some study and experimentation, can fairly reliably predict the actions a conciousness will take in response to specific stimuli", 0, NULL);
    Add_Prize(200, "Ergonomics", "You have a solid understanding of how people interact with the world around them, and as a result are able to create things that are natural, comfortable and intuitive to use. You can pick apart any body plan and design tools, equipment and other devices in such a way that they are a joy to work with... or a nightmare", 0, NULL);
    Add_Prize(200, "Cognitive Analysis", "You are well versed in the workings of a mind, how to render even the seemingly chaotic realms of emotion into fairly clear workings. Through studies of people's actions you can extrapolate an accurate model their individual minds, or a more general set of trends", 0, NULL);
    Add_Prize(200, "Armchair General", "You might not have put boots on the ground, but at the end of the day, it is logistics that win wars. You have the knowledge of someone who has studied hundreds, if not thousands of wars, and can plot out supply lines and deployments with ease. Not only can you utilise your own resources well, you can also analyse the movements of your foes to determine their strategies and plots", 0, NULL);
    Add_Prize(200, "Educational", "You understand the workings of a mind well enough to understand how to best impart information unto it with whatever tools you so choose. While this mainly covers your own species, you have enough broadly applicable insight to adapt to others with a little practice", 0, NULL);
    Add_Prize(350, "Habitual", "you gain the ability to instil habits into your mind and those of others, though that is much easier with their co-operation. This allows you to instil certain behaviours that they will feel natural doing and even find skipping somewhat annoying", 0, NULL);
    Add_Prize(0, "Spoon Bending", "Something of a parlour trick, but no less a useful telekinetic skill. You know how to project a small but still reasonable amount of force onto any point within ten centimeters of you. This isn't precise or well controlled at first, but is a fairly useful training exercise for those skills anyways", 0, Table_Resolver(22));
    Add_Prize(300, "Libromancy", "You have gained an understanding of a set of skills focused on the manipulaiton of recorded information. Beginners know how to scry for specific information in large volumes of text, easily record and absorb such information as well as perform complex rituals to uncover the meaning of words in languages they do not speak. Adepts become capable of generating accounts of events, individuals and items that they have heard of uncovering facts that may have even been considered lost to time", 3, Table_Resolver(83));
    Add_Prize(0, "Haunting Whispers", "You can open your ears to the whispers of what lays beyond. Though be warned, even if it may not be useful to you, what you learn here is not for the faint of heart. Even if you mind might be able to handle it, your body may not, and spilling these secrets to others can have mixed results", 0, Table_Resolver(104));
    Add_Prize(0, "Persistent Whispers", "You know how to phrase and reveal things in such a way that they remain in the minds of those who hear them", 0, NULL);
    Add_Prize(0, "Eternal", "Your understanding of the underlying processes of the world allows you to create objects and structures that seem to be immune to deterioration - be it due to age, weather or otherwise", 0, Table_Resolver(104));
    Add_Prize(150, "Conjurer's Container", "You know an enchantment that can be applied to containers of all kinds, anchoring a pocket of space to them that massively multiplies the internal volume and hides the mass of all stored things from the outside world", 0, Table_Resolver(83));
    Add_Prize(250, "Planar Support Systems", "The boundary of each plane is the first line of defence when it comes to any sort of extraplanar incursion. You know how to build complex and power hungry systems that will reinforce the barrier locally, with your systems able to project out to about five billion kilometres given sufficient power and enough installations to spread out the strain", 0, NULL);
    Add_Prize(0, "Corners of Existence", "You have a deep understanding of spatial topology, enough to see where the conditions are just right that the dimensions are a little softer than they should be. It's more common than you would think! Regardless, you know how to make use of these spaces as stashes that fit more than you would think or even hiding places that most usually would not notice", 0, NULL);
