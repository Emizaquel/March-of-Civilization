...
int main(int argc, char const *argv[])
{
    ...
    Add_Prize(500, "The Cycle", "Souls are real, you know that, and through observation of their passage you have become aware of other places they go to, drawn through a mystical network of bonds and connections. You have uncovered how to connect to these afterlives, though surviving there is another matter", 255, NULL);
    ...
    Add_Prize(0, "Legacy", "All of these strange, mystical forces flow within you, growing in power and strength. While normally, it would be for your children to carry forth your legacy unto this world, you may now trigger a similar awakening of one of your powers in others through the means of a ritual.", 1, NULL);
    Add_Prize(0, "Fundamentals", "Congrats! You have all the prerequisites for every other power in the March! As a bonus, you now are now able to pick up the basics of any field in about an hour of focused study", 1, NULL);
    ...
    Add_Prize(200, "Song of the Ages", "You can sing! In fact, you can sing amazingly well. Your voice and skill are such that this alone would make your performances almost hypnotic, inspiring emotions and ", 1, NULL);
