...
static const uint16_t core_prizes = 417;
...
int main(int argc, char const *argv[])
{
    ...
    Add_Prize(150, "Enduring", "You know how to design and modify systems in such a way as to protect them from the ravages of time - allowing them to operate as they should for tens of times longer than they otherwise would be capable of.", 1, NULL);
