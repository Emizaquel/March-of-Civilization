...
int main(int argc, char const *argv[])
{
    ...
    Add_Prize(500, "Alternate Forms", "A sort of limited shapeshifting, gain the ability to take on an alternate form capable of supporting your soul and consciousness, a robot, animal or even an entirely separate species. repeat max", 1, NULL);
